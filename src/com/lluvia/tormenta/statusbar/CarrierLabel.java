...
public class CarrierLabel extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mShowCarrierLabel.setEntries(lluviaUtils.hasNotch(getActivity()) ? NotchEntries : NonNotchEntries);
        mShowCarrierLabel.setDefaultValue("1");
        mShowCarrierLabel.setEntryValues(lluviaUtils.hasNotch(getActivity()) ? NotchValues : NonNotchValues);
