package com.tormenta.settings.preference;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String DERPQUESTSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, DERPQUESTSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, DERPQUESTSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(DERPQUESTSETTINGSNS, "interval");
            if(newInterval != null)
